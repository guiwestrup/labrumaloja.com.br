...
<v-topbar>
    ...
    <div class="flex items-center justify-between border border-b border-l-0 border-r-0 border-t-0 px-16">
        <!-- Currencies - Shimmer apenas se houver mais de uma moeda -->
        ...
        <!-- Locales - Shimmer apenas se houver mais de um locale -->
...
@pushOnce('scripts')
    ...
    >
        <div class="flex w-full items-center justify-between border border-b border-l-0 border-r-0 border-t-0 px-16">
            ...
            <!-- Currency Switcher - Oculto quando há apenas uma moeda -->
            @if(core()->getCurrentChannel()->currencies()->count() > 1)
            ...
            <!-- Locales Switcher - Oculto quando há apenas um locale -->
            @if(core()->getCurrentChannel()->locales()->count() > 1)
