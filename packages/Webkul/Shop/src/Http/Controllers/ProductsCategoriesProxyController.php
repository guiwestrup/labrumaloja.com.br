...
class ProductsCategoriesProxyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($product) {
            // Verificar url_key usando o getter que tem fallback para qualquer locale
            // Se o produto foi encontrado pelo findBySlug, significa que o url_key existe em algum locale
